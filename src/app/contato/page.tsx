...
import ButtonLaranja from "@/components/custom/Button";
import { SendEmailInterface } from "../api/sendgrid/interface";
...
export default function Contato() {
  ...
  const handleSubmit = async () => {
    ...
    const data: SendEmailInterface = {
      ...
      from: {
        email: email || "causadepadreramon@gmail.com",
      ...
      <div className="flex justify-center rounded-2xl">
        <form onSubmit={handleSubmit} className="flex justify-center">
          <div className="p-1 bg-white rounded-lg m-5 bg-transparent">
            ...
            <div>
              <div className="text-center text-slate-700 py-3 font-mono text-xl">
                Envie a graça também pelo whastapp
              </div>
              <div className="mb-8 mt-3">
                <div className="text-center flex flex-col items-center">
                  <Link
                    target="_blank"
                    href={`https://wa.me/5516991961997?text=Ola! Gostaria de falar sobre a Causa de Padre Ramón `}
                  >
