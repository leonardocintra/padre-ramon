...
export const biographyText = (
  <div className="prose max-w-none text-gray-800 leading-relaxed">
    ...
    <p className={paragrafo}>
      Tendo sentido o chamado a ser{" "}
      <span className={semiDestaque}>presbítero e missionário</span>, ingressou,
      num primeiro momento, no Aspirantado Salesiano de Girona (Espanha) em{" "}
      <span className="font-semibold">1957</span>.
    </p>
...
export const biographyText2 = (
  <div className="prose max-w-none text-gray-800 leading-relaxed">
    ...
    <p className={paragrafo}>
      ...
      e um <strong>religioso exemplar</strong>.
    </p>
...
export const biographyText3 = (
  <div className="prose max-w-none text-gray-800  leading-relaxed">
    ...
    <p className={paragrafo}>
      Exerceu a missão itinerante nas regiões de{" "}
...
export const biographyText8 = (
  <div className="prose max-w-none text-gray-800  leading-relaxed">
    ...
    <blockquote className="border-l-4 border-gray-300 pl-4 italic text-gray-600">
      ...
      <br />
      Cumpriu com grande entrega a sua missão na terra. Que a sua entrega ao
      anúncio itinerante do Evangelho nos mantenha a todos em constante
      peregrinação.
    </blockquote>
  </div>
);
